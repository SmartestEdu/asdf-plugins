...
- `dyff` - YAML and Kubernetes manifest comparison tool ([homeport/dyff](https://github.com/homeport/dyff))
...
asdf plugin add dyff https://github.com/SmartestEdu/asdf-plugins.git
```
